...
const Analytics = () => {
  return (
    <ScrollMotionEffect
      ...
      duration="1000"
      className={
        "max-w-[420px] md:w-full h-full m-auto bg-[#F5F5F5] rounded-2xl p-4 flex flex-col justify-between lg:col-start-1 lg:row-start-3 xl:col-start-3 xl:row-start-1 2xl:row-start-1 2xl:col-start-3 "
      }
    >
