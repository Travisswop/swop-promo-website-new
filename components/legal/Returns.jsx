...
const Returns = () => {
  return (
    <div className='p-0'>
      ...
      <h1 className='font-bold py-4'>Returns</h1>
      ...
      <h1 className='font-bold py-4'>Exceptions / non-returnable items</h1>
      ...
      <h1 className='font-bold py-4'>Exchanges</h1>
      ...
      <h1 className='font-bold py-4'>Refunds</h1>
